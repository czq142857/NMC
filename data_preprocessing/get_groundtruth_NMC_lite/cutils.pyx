...
def get_face_points(int v0, int v1, int v2, int v3, int center, float[:, ::1] optimized_V, int[:, ::1] optimized_F, float[:, ::1] reference_V, int rv_count):
        ...
        if v1==0:
            if v2==0:
                ...
                if v3==0: #0010
                    ...
                    optimized_F[1,0] = c0
                    optimized_F[1,1] = e1
                    optimized_V[c0,0] = (optimized_V[e3,0]+optimized_V[e1,0])/2
                    optimized_V[c0,1] = (optimized_V[e3,1]+optimized_V[e1,1])/2
        else:
            if v2==0:
                if v3==0: #0100
                    F_num = 2
                ...
                if v3==0: #0110
                    ...
                    optimized_F[1,0] = c0
                    optimized_F[1,1] = e0
                    optimized_V[c0,0] = (optimized_V[e2,0]+optimized_V[e0,0])/2
                    optimized_V[c0,1] = (optimized_V[e2,1]+optimized_V[e0,1])/2
                else:     #0111
                    F_num = 2
                    optimized_F[0,0] = e3
                    optimized_F[0,1] = c0
    ...
    #symmetry when 0011 1100 0110 1001
    if (v0==0 and v1==0 and v2==1 and v3==1) or (v0==1 and v1==1 and v2==0 and v3==0) or (v0==0 and v1==1 and v2==1 and v3==0) or (v0==1 and v1==0 and v2==0 and v3==1):
        optimized_V[c1,0] = optimized_V[c0,0]
        optimized_V[c1,1] = optimized_V[c0,1]
        optimized_V[c2,0] = optimized_V[c0,0]
        optimized_V[c2,1] = optimized_V[c0,1]
